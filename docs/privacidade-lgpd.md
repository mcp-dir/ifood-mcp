...
iFood segue a LGPD (Lei nº 13.709/2018).
...
|---|---|---|
| **iFood** | BR | delivery/restaurant platform API (provedor dos dados da loja) |
...
Acessar, corrigir, eliminar, portar, revogar consentimento. Contato: [ifood@mcp.ai](mailto:ifood@mcp.ai). Reclamações: [ANPD](https://www.gov.br/anpd/pt-br).
